<template>
  <div class="container mt-5">
    ...
    <div class="mt-3">
      <router-link to="/dashboard/doctor" class="btn btn-link">Back to Dashboard</router-link>
      <router-link to="/doctor/register" class="btn btn-link">Don't have an account? Register</router-link>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async login() {
      ...
      try {
        ...
        this.loginStatus = {
          type: 'danger',
          message: 'Invalid credentials for doctor. Please try again.'
        };
      } finally {
